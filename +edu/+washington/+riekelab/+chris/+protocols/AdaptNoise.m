classdef AdaptNoise < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    properties
        ...
        stimulusClass = 'center-const-surround' % Stimulus class: spot, center-full, center-surround, center-const-surround
