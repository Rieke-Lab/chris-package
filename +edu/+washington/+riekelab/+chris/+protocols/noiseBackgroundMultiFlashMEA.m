classdef noiseBackgroundMultiFlashMEA < manookinlab.protocols.ManookinLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            % Update stimTime based on number of flashes
            obj.stimTime = obj.numberOfFlashes * obj.interFlashInterval;
            
            % Generate flash timesclassdef noiseBackgroundMultiFlash < manookinlab.protocols.ManookinLabStageProtocol
    properties
        preTime = 1000   % ms
        stimTime = 100000  % ms
        tailTime = 1000  % ms
