classdef spatialTransferGratingRodLongEpoch < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    properties
        apertureDiameter=200   % um
         % um
        flashDuration=50 % ms
        barWidth=[ 30 20 40 80 120]
        variableFlashTime=[50  200 400 ]
        fixFlashTime=2000
        meanIntensity=0.2
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            ...
            barWidthIndex=mod((obj.numEpochsCompleted-rem(obj.numEpochsCompleted,length(obj.phases)))/length(obj.phases),length(obj.barWidth))+1;
            obj.flashTimes=[obj.fixFlashTime obj.variableFlashTime obj.preTime-obj.fixFlashTime ...
                obj.preTime+obj.fixFlashTime obj.preTime+obj.variableFlashTime ...
                obj.preTime+obj.stimTime-obj.fixFlashTime];
            ...
            obj.adaptMatrix.test=obj.createGrateMat((obj.meanIntensity+obj.adaptStepIntensity)/2,...
               abs(obj.adaptStepIntensity-obj.meanIntensity)/(obj.meanIntensity+obj.adaptStepIntensity),0,'seesaw');
            ...
            obj.testMatrix.test=obj.createGrateMat(obj.testIntensity/2,1, obj.currentPhase,'seesaw');  % this create the test grating
