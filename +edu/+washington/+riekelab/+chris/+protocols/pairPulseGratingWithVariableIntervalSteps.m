classdef pairPulseGratingWithVariableIntervalSteps < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    properties
        ...
        stepContrast = 0.9  % the opposing step with be just -flashContrast for simplicity
    ...
    methods
        ...
        function p = createPresentation(obj)
            try
                ...
                step.color = obj.meanIntensity*(1+obj.stepContrast);
                ...
                stepController = stage.builtin.controllers.PropertyController(step, 'visible', ...
                     @(state) state.time >= (obj.preTime + obj.grateDuration) * 1e-3 && state.time < (obj.preTime + obj.grateDuration+obj.currentInterval) * 1e-3);
