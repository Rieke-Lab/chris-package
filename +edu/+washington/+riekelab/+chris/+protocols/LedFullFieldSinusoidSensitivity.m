classdef LedFullFieldSinusoidSensitivity < edu.washington.riekelab.protocols.RiekeLabProtocol
    % Full-field LED sinusoids for measuring response modulation.
    ...
    properties
        ...
        sinusoidContrasts = 0.5               % fraction of mean
        lightMeans = 0.4                      % LED units
