classdef LinearEquivalentDisc < edu.washington.riekelab.chris.protocols.NaturalImageFlashProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.allEquivalentIntensityValues = ...
                edu.washington.riekelab.chris.protocols.NaturalImageFlashProtocol.getEquivalentIntensityValues(...
                obj, 0, obj.apertureDiameter, obj.rfSigmaCenter);
        end
        
        function prepareEpoch(obj, epoch)
            prepareEpoch@edu.washington.riekelab.chris.protocols.NaturalImageFlashProtocol(obj, epoch);
            ...
            obj.imagePatchMatrix = ...
                edu.washington.riekelab.chris.protocols.NaturalImageFlashProtocol.getImagePatchMatrix(...
