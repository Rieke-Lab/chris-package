...
classdef PresentMoviesFixedSize < manookinlab.protocols.ManookinLabStageProtocol
    ...
    properties
        ...
        fileFolder = 'annulus_stimuli';     % Folder containing videos
        backgroundIntensity = 0.2;      % 0 - 1 (corresponds to image intensities in folder)
        magnificationFactor = 6.0;     % factor to scale movie size. 1.0 will play at original size.
        randomize = true;               % whether to randomize movies shown
        onlineAnalysis = 'none'
        numberOfAverages = uint16(5) % number of epochs to queue
        local_parent_directory = 'C:\Users\chenq\Documents\chris-package\+edu\+washington\+riekelab\+chris\+resources\movies\'; % General folder
    end
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            %     stage_dir = 'C:\Users\Public\Documents\GitRepos\Symphony2\movies\';
            % end
            obj.stage_movie_directory = strcat(obj.local_parent_directory, obj.fileFolder);
