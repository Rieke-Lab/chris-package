classdef LinearEquivalentDiscConeLinContrastScalor < edu.washington.riekelab.chris.protocols.NatImgFlashWithContrastScalor
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            % Keep each image/disc pair (or triplet) together, cycle scalors,
