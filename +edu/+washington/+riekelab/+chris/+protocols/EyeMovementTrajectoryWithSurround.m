classdef EyeMovementTrajectoryWithSurround < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.showFigure('edu.washington.riekelab.turner.figures.MeanResponseFigure',...
                obj.rig.getDevice(obj.amp),'recordingType',obj.onlineAnalysis, 'groupBy',{'surroundTag'});
            ...
            obj.imageMeanIntensity=imageMean;
        ...
        function p = createPresentation(obj)
            ...
            if strcmp(obj.surroundTag,'none')
                ...
                rect.color = obj.imageMeanIntensity*obj.surroundScale;
        ...
        function prepareEpoch(obj, epoch)
            ...
            surroundInd = mod(obj.numEpochsCompleted,2);
            if surroundInd == 1
                obj.surroundTag = 'imageMean';
            elseif surroundInd == 0
            ...
            epoch.addParameter('imageMeanIntensity', obj.imageMeanIntensity);
        end
