classdef LedSinusoidIncrementDecrement < edu.washington.riekelab.protocols.RiekeLabProtocol
    % Full-field LED sinusoids for excitatory outward/inward analysis.
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            ...
            % numEpochsPrepared at this point.
            %
            % Therefore the correct index is numEpochsPrepared,
            % NOT numEpochsPrepared + 1.
            epochIndex = ...
                obj.numEpochsPrepared;


            % Safety check for epoch bookkeeping.
            if epochIndex < 1 || ...
    ...
    methods (Access = private)
        ...
        function stim = createLedStimulus(obj)
            ...
            gen = ...
                edu.washington.riekelab.chris.stimuli. ...
                SinusoidPlusNoiseGenerator();
        ...
        function validateParameters(obj)
            ...
            if isempty(obj.temporalFrequencies) || ...
                ...
                error( ...
                    ['temporalFrequencies must contain ', ...
                    'positive values.']);
            end
            ...
            if isempty(obj.sinusoidContrasts) || ...
                ...
                error( ...
                    ['sinusoidContrasts must contain ', ...
            ...
            if isempty(obj.lightMeans) || ...
                ...
                error( ...
                    ['lightMeans must contain finite, ', ...
                    'nonnegative values.']);
            end
