classdef ConeLinearizationGratingPlusMean < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function constructStimuli(obj)
            ...
            meanVector = obj.backgroundIsomerizations ...
                * ones(1, numel(stimulusData.stepCorrected));
