classdef variableMeanFlash < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    methods
        ...
        function tf = shouldContinuePreparingEpochs(obj)
            tf = obj.numEpochsPrepared < obj.numberOfAverages*obj.meanIntensity*obj.flashContrast;
        end
        
        function tf = shouldContinueRun(obj)
            tf = obj.numEpochsCompleted < obj.numberOfAverages*obj.meanIntensity*obj.flashContrast;
        end
