classdef monitorVariableMeanNoiseLinearFilterFigure < symphonyui.core.FigureHandler
    ...
    methods
        ...
        function obj = monitorVariableMeanNoiseLinearFilterFigure(ampDevice, frameMonitor, stageDevice, varargin)
        ...
        function handleEpoch(obj, epoch)
            ...
            obj.newFilter = edu.washington.riekelab.chris.utils.getLinearFilterOnline(obj.allStimuli,obj.allResponses,...
