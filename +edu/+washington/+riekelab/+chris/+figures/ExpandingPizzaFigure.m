classdef ExpandingPizzaFigure < symphonyui.core.FigureHandler
    ...
    methods
        ...
        function obj = ExpandingPizzaFigure(ampDevice, varargin)
        ...
        function createUi(obj)
            ...
            obj.axesHandle = axes( ...
                ...
                'XTickMode', 'auto');
            xlabel(obj.axesHandle, 'slice number');
        ...
        function handleEpoch(obj, epoch)
            ...
            currentPizzaSize =epoch.parameters('currentSliceNumber');
