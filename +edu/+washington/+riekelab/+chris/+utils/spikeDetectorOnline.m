...
[Ntraces,L] = size(D);
Dhighpass = edu.washington.riekelab.chris.utils.highPassFilter(D,HighPassCut_spikes,SampleInterval);
...
for i=1:Ntraces
    ...
    %get peaks
    [peaks,peak_times] = edu.washington.riekelab.chris.utils.getPeaks(trace,1); %positive peaks
